 ...
 * <p>
 * Can be disabled by setting {@code redis.client.enabled=false} in application properties.
 */
@Slf4j
...
public class RedisClientAutoConfiguration {
    ...
    @Bean
    @ConditionalOnMissingBean
    public RedisCommandExecutor redisCommandExecutor(RedisClientProperties properties) {
